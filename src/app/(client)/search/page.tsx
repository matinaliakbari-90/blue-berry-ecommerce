...
export default async function SearchPage({
    ...
    if (!products?.length) {
        return (
            <div className="flex flex-col items-center justify-normal min-h-screen bg-gray-100 p-4">
                <div className="bg-white p-8 h-40 rounded-lg mt-68 shadow-md w-full md:max-w-4xl text-center">
    ...
    return (
        <div className="flex flex-col items-center justify-top min-h-screen bg-gray-100">
            <div className="max-w-7xl mx-auto p-8 bg-white rounded-lg shadow-md mt-44 md:mt-30">
